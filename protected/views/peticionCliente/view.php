...
array('label'=>'Update PeticionCliente','url'=>array('update','id'=>$model->id)),
array('label'=>'Delete PeticionCliente','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
