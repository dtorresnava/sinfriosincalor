<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textFieldGroup($model,'peticion_cliente_id',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>

		<?php echo $form->textFieldGroup($model,'producto_id',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>

		<?php echo $form->textFieldGroup($model,'servicio_id',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>
		...
		<?php echo $form->datePickerGroup($model,'fecha_presupuesto',array('widgetOptions'=>array('options'=>array(),'htmlOptions'=>array('class'=>'span5')), 'prepend'=>'<i class="glyphicon glyphicon-calendar"></i>', 'append'=>'Click on Month/Year to select a different Month/Year.')); ?>
		...
		<?php echo $form->textFieldGroup($model,'validar',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>
