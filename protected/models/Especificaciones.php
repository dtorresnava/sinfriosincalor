...
class Especificaciones extends CActiveRecord {
	...
	public function rules() {
		...
		return array (
				array (
						'producto_id, potencia_frio, potencia_calor, eficiencia_frio, eficiencia_calor, consumo_frio, consumo_calor, dimencion_alto, dimencion_ancho, dimencion_largo, peso, conexion_peque単a, conexion_grande, tipo_caudal, posicion_tubos_conextion',
						'required' 
				),
				array (
						'producto_id, conexion_peque単a, conexion_grande',
						'numerical',
						'integerOnly' => true 
				),
				array (
						'potencia_frio, potencia_calor, eficiencia_frio, eficiencia_calor, consumo_frio, consumo_calor, dimencion_alto, dimencion_ancho, dimencion_largo, peso',
						'numerical' 
				),
				array (
						'tipo_caudal',
				...
				array (
						'id, producto_id, potencia_frio, potencia_calor, eficiencia_frio, eficiencia_calor, consumo_frio, consumo_calor, dimencion_alto, dimencion_ancho, dimencion_largo, peso, conexion_peque単a, conexion_grande, tipo_caudal, posicion_tubos_conextion',
						'safe',
						'on' => 'search' 
				) 
		);
